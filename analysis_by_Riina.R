...
for(i in 1:41){
  ...
  mean_wa[i] = mean(newdata$wa[idx])
  cy[i] = round(mean(newdata$SSB[idx]), digits=0)
}

par(mfrow = c(3, 3), tck=-0.02,mar=c(2.5,2.5,2.5,2.5), mgp = c(1.3,0.3,0))

if(TRUE){
plot(cor1 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor1 ~ cy)
abline(h=0)
...
plot(cor2 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor2 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor3 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor3 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor4 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor4 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor5 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor5 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor6 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor6 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor7 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor7 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor8 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor8 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
...
plot(cor9 ~ cy, ylab="Pearsons' r", xlab="Mean SSB", pch = 16)
lines(cor9 ~ cy)
abline(h=0)
abline(v=c(40, 60, 80, 100), lwd =.5, col=rgb(0,0,0,alpha = 0.5))
par(new = T)
